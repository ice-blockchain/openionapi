...
func (s *Action) encodeFields(e *jx.Encoder) {
	...
	{
		if s.ExtraCurrencyTransfer.Set {
			e.FieldStart("ExtraCurrencyTransfer")
			s.ExtraCurrencyTransfer.Encode(e)
		}
	}
	{
...
func (s *Action) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "ExtraCurrencyTransfer":
			if err := func() error {
				s.ExtraCurrencyTransfer.Reset()
				if err := s.ExtraCurrencyTransfer.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"ExtraCurrencyTransfer\"")
			}
		case "ContractDeploy":
			if err := func() error {
...
var jsonFieldsNameOfDecodedMessageExtInMsgDecoded = [4]string{
	0: "wallet_v3",
	1: "wallet_v4",
	2: "wallet_v5",
	3: "wallet_highload_v2",
}
...
func (s *DecodedMessageExtInMsgDecoded) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "wallet_v5":
			if err := func() error {
				s.WalletV5.Reset()
				if err := s.WalletV5.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"wallet_v5\"")
			}
...
// Encode implements json.Marshaler.
func (s *DecodedMessageExtInMsgDecodedWalletV5) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
func (s *DecodedMessageExtInMsgDecodedWalletV5) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DecodedMessageExtInMsgDecodedWalletV5 to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode DecodedMessageExtInMsgDecodedWalletV5")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfDecodedMessageExtInMsgDecodedWalletV5) {
					name = jsonFieldsNameOfDecodedMessageExtInMsgDecodedWalletV5[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *DecodedMessageExtInMsgDecodedWalletV5) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *DecodedMessageExtInMsgDecodedWalletV5) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// Encode implements json.Marshaler.
func (s *EcPreview) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
func (s *EcPreview) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode EcPreview to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode EcPreview")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfEcPreview) {
					name = jsonFieldsNameOfEcPreview[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *EcPreview) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *EcPreview) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// Encode implements json.Marshaler.
func (s *ExtraCurrency) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *ExtraCurrency) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("amount")
		e.Str(s.Amount)
	}
...
var jsonFieldsNameOfExtraCurrency = [2]string{
	0: "amount",
	1: "preview",
}

// Decode decodes ExtraCurrency from json.
func (s *ExtraCurrency) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ExtraCurrency to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ExtraCurrency")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfExtraCurrency) {
					name = jsonFieldsNameOfExtraCurrency[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *ExtraCurrency) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *ExtraCurrency) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *ExtraCurrencyTransferAction) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *ExtraCurrencyTransferAction) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("sender")
		s.Sender.Encode(e)
	}
...
func (s *ExtraCurrencyTransferAction) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ExtraCurrencyTransferAction to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ExtraCurrencyTransferAction")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfExtraCurrencyTransferAction) {
					name = jsonFieldsNameOfExtraCurrencyTransferAction[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *ExtraCurrencyTransferAction) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// Encode implements json.Marshaler.
func (s *GetJettonInfosByAddressesReq) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *GetJettonInfosByAddressesReq) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("account_ids")
		e.ArrStart()
		for _, elem := range s.AccountIds {
...
var jsonFieldsNameOfGetJettonInfosByAddressesReq = [1]string{
	0: "account_ids",
}

// Decode decodes GetJettonInfosByAddressesReq from json.
func (s *GetJettonInfosByAddressesReq) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetJettonInfosByAddressesReq to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode GetJettonInfosByAddressesReq")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfGetJettonInfosByAddressesReq) {
					name = jsonFieldsNameOfGetJettonInfosByAddressesReq[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *GetJettonInfosByAddressesReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *GetJettonInfosByAddressesReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// Encode implements json.Marshaler.
func (s *GetNftCollectionItemsByAddressesReq) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *GetNftCollectionItemsByAddressesReq) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("account_ids")
		e.ArrStart()
		for _, elem := range s.AccountIds {
...
var jsonFieldsNameOfGetNftCollectionItemsByAddressesReq = [1]string{
	0: "account_ids",
}

// Decode decodes GetNftCollectionItemsByAddressesReq from json.
func (s *GetNftCollectionItemsByAddressesReq) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetNftCollectionItemsByAddressesReq to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode GetNftCollectionItemsByAddressesReq")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfGetNftCollectionItemsByAddressesReq) {
					name = jsonFieldsNameOfGetNftCollectionItemsByAddressesReq[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *GetNftCollectionItemsByAddressesReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *GetNftCollectionItemsByAddressesReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
func (s *Message) encodeFields(e *jx.Encoder) {
	...
	{
		if s.ValueExtra != nil {
			e.FieldStart("value_extra")
			e.ArrStart()
			for _, elem := range s.ValueExtra {
				elem.Encode(e)
			}
			e.ArrEnd()
		}
...
var jsonFieldsNameOfMessage = [19]string{
	0:  "msg_type",
	1:  "created_lt",
	2:  "ihr_disabled",
	3:  "bounce",
...
func (s *Message) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "value_extra":
			if err := func() error {
				s.ValueExtra = make([]ExtraCurrency, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem ExtraCurrency
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.ValueExtra = append(s.ValueExtra, elem)
					return nil
				}); err != nil {
					return err
				}
				...
				return errors.Wrap(err, "decode field \"value_extra\"")
			}
		case "fwd_fee":
			requiredBitSet[0] |= 1 << 7
			if err := func() error {
...
var jsonFieldsNameOfMethod = [2]string{
	0: "id",
	1: "method",
}
...
// Encode encodes DecodedMessageExtInMsgDecodedWalletV5 as json.
func (o OptDecodedMessageExtInMsgDecodedWalletV5) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	o.Value.Encode(e)
...
// Decode decodes DecodedMessageExtInMsgDecodedWalletV5 from json.
func (o *OptDecodedMessageExtInMsgDecodedWalletV5) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptDecodedMessageExtInMsgDecodedWalletV5 to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptDecodedMessageExtInMsgDecodedWalletV5) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptDecodedMessageExtInMsgDecodedWalletV5) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// Decode decodes ExtraCurrencyTransferAction from json.
func (o *OptExtraCurrencyTransferAction) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptExtraCurrencyTransferAction to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptExtraCurrencyTransferAction) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// Encode encodes GetJettonInfosByAddressesReq as json.
func (o OptGetJettonInfosByAddressesReq) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	o.Value.Encode(e)
...
// Decode decodes GetJettonInfosByAddressesReq from json.
func (o *OptGetJettonInfosByAddressesReq) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptGetJettonInfosByAddressesReq to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptGetJettonInfosByAddressesReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptGetJettonInfosByAddressesReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes GetNftCollectionItemsByAddressesReq as json.
func (o OptGetNftCollectionItemsByAddressesReq) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	o.Value.Encode(e)
...
// Decode decodes GetNftCollectionItemsByAddressesReq from json.
func (o *OptGetNftCollectionItemsByAddressesReq) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptGetNftCollectionItemsByAddressesReq to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptGetNftCollectionItemsByAddressesReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptGetNftCollectionItemsByAddressesReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// Decode decodes SendBlockchainMessageReqMeta from json.
func (o *OptSendBlockchainMessageReqMeta) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptSendBlockchainMessageReqMeta to nil")
	}
	o.Set = true
	o.Value = make(SendBlockchainMessageReqMeta)
	if err := o.Value.Decode(d); err != nil {
		return err
	}
	return nil
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptSendBlockchainMessageReqMeta) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptSendBlockchainMessageReqMeta) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
var jsonFieldsNameOfSendBlockchainMessageReq = [3]string{
	0: "boc",
	1: "batch",
	2: "meta",
}
...
// Encode implements json.Marshaler.
func (s SendBlockchainMessageReqMeta) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields implements json.Marshaler.
func (s SendBlockchainMessageReqMeta) encodeFields(e *jx.Encoder) {
	for k, elem := range s {
		e.FieldStart(k)
...
// Decode decodes SendBlockchainMessageReqMeta from json.
func (s *SendBlockchainMessageReqMeta) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SendBlockchainMessageReqMeta to nil")
	}
	m := s.init()
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		var elem string
		...
		return errors.Wrap(err, "decode SendBlockchainMessageReqMeta")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s SendBlockchainMessageReqMeta) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SendBlockchainMessageReqMeta) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
var jsonFieldsNameOfSource = [1]string{
	0: "files",
}
...
// Encode implements json.Marshaler.
func (s *SourceFile) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *SourceFile) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("name")
		e.Str(s.Name)
	}
	...
	{
		e.FieldStart("is_entrypoint")
		e.Bool(s.IsEntrypoint)
	}
	{
		e.FieldStart("is_std_lib")
		e.Bool(s.IsStdLib)
	}
	{
		e.FieldStart("include_in_command")
		e.Bool(s.IncludeInCommand)
	}
}

var jsonFieldsNameOfSourceFile = [5]string{
	0: "name",
	1: "content",
	2: "is_entrypoint",
	3: "is_std_lib",
	4: "include_in_command",
}

// Decode decodes SourceFile from json.
func (s *SourceFile) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SourceFile to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "is_entrypoint":
			...
			if err := func() error {
				v, err := d.Bool()
				s.IsEntrypoint = bool(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"is_entrypoint\"")
			}
		case "is_std_lib":
			requiredBitSet[0] |= 1 << 3
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"is_std_lib\"")
			}
		case "include_in_command":
			requiredBitSet[0] |= 1 << 4
			if err := func() error {
				v, err := d.Bool()
				s.IncludeInCommand = bool(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"include_in_command\"")
			}
		default:
			return d.Skip()
		}
		...
		return errors.Wrap(err, "decode SourceFile")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSourceFile) {
					name = jsonFieldsNameOfSourceFile[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
var jsonFieldsNameOfValueFlowJettonsItem = [4]string{
	0: "account",
	1: "jetton",
	2: "qty",
	3: "quantity",
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "qty":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"qty\"")
			}
		case "quantity":
			requiredBitSet[0] |= 1 << 3
			if err := func() error {
